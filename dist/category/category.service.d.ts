...
export declare class CategoryService {
    ...
    constructor(categoryModel: Model<CategoryDocument>, cloudinaryService: CloudinaryService);
    ...
    updatecategoryPhoto(id: string, photo: PhotoI): Promise<Category & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    ...
    changeStatus(id: string, status: boolean): Promise<Category & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    filterCategory(filterCategoryDto: FilterCategoryDto): Promise<Category[]>;
}
