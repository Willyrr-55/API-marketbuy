...
exports.JwtToRefreshGuard = void 0;
const common_1 = require("@nestjs/common");
const jwt_1 = require("@nestjs/jwt");
const config_1 = require("../config");
const users_service_1 = require("../users/users.service");
let JwtToRefreshGuard = class JwtToRefreshGuard {
    ...
    async canActivate(context) {
        ...
        try {
            ...
            const decode = await this.jwtService.verify(token, { secret: config_1.default.SECRETJWT, ignoreExpiration: true });
...
JwtToRefreshGuard = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [jwt_1.JwtService, users_service_1.UsersService])
], JwtToRefreshGuard);
exports.JwtToRefreshGuard = JwtToRefreshGuard;
//# sourceMappingURL=jwt-to-refresh.guard.js.map